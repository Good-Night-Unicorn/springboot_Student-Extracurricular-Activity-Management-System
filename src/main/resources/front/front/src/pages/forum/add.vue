<template>
	<div :style='{"alignContent":"flex-start","padding":"0 calc((100% - 1200px)/2)","margin":"0 auto","alignItems":"flex-start","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","fontSize":"16px","position":"relative"}'>
		<div class="section-title" :style='{"padding":"0","margin":"20px 0 0","color":"#000","textAlign":"center","background":"url(https://codegen.caihongy.cn/20250204/d150dc26e9f44cb0b06dfc34989fcba3.png) no-repeat center bottom","width":"100%","fontSize":"26px","lineHeight":"60px","position":"relative","height":"60px"}'>活动论坛</div>
		<div class="back_box">
		...
		<el-form class="add-update-preview" :model="form" :rules="rules" ref="form" label-width="180px">
			...
			<el-form-item :style='{"padding":"0","textAlign":"center","margin":"20px 0"}'>
				<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 20px 0 0","textAlign":"center","display":"inline-block","minWidth":"120px","borderRadius":"0px","background":"rgb(0, 78, 162)","width":"auto","lineHeight":"40px","fontSize":"16px","height":"40px"}' type="primary" @click="submitForm('form')">
