<template>
	<div :style='{"padding":"0 calc((100% - 1200px)/2) 20px","margin":"0px auto","color":"#666","background":"#fff","width":"100%","fontSize":"16px","position":"relative"}'>
		...
		<div v-if="storeupType==1" class="section-title" :style='{"padding":"0","margin":"20px 0 0","color":"#000","textAlign":"center","background":"url(https://codegen.caihongy.cn/20250204/d150dc26e9f44cb0b06dfc34989fcba3.png) no-repeat center bottom","width":"100%","fontSize":"26px","lineHeight":"60px","position":"relative","height":"60px"}'>我的收藏</div>
