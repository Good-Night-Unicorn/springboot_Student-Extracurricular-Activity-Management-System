		...
		<div class="detail-preview">
			<div class="attr">
				<div class="info">
					...
					<div class="item">
						<div class="lable">报名备注</div>
						<div class="text "  >{{detail.baomingbeizhu}}</div>
					</div>
					<div class="item">
					...
					<div class="btn_box">
						<el-button class="editBtn" v-if="btnAuth('huodongbaoming','修改')" @click="editClick">修改</el-button>
						<el-button class="delBtn" v-if="btnAuth('huodongbaoming','删除')" @click="delClick">删除</el-button>
						<el-button class="reserveBtn" 
							v-if="btnAuth('huodongbaoming','活动评价')" 
							@click="onAcross('huodongpingjia','','','[1]','已评价')" type="warning">
							活动评价
						</el-button>
					</div>
				</div>
