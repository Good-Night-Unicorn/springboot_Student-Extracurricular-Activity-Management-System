<template>
	<div class="main-content" :style='{"width":"calc(100% - 0px)","padding":"20px 30px 40px","margin":"0 auto","fontSize":"15px","textAlign":"center","background":"none"}'>
		...
		<div v-if="!showFlag" style="width: 100%;">
			<el-form :style='{"padding":"10px 0","margin":"0","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","justifyContent":"space-between"}' :inline="true" :model="searchForm" class="center-form-pv">
				<el-row :style='{"padding":"10px 0","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"auto","order":"2"}'>
					...
					<el-button class="search" :style='{"border":"0","cursor":"pointer","padding":"0 10px 0 5px","color":"#fff","borderRadius":"4px","background":"#ffb46b","width":"auto","fontSize":"15px","height":"34px"}' type="success" @click="search()">
				...
				<el-table
					...
					<el-table-column
						...
						<template slot-scope="scope">
							<el-button
								type="text"
								:style='{"border":"1px solid #000","cursor":"pointer","padding":"0 0 0px","margin":"0 5px 5px 0","color":"#000","borderRadius":"4px","background":"#fff","width":"auto","fontSize":"14px","minWidth":"68px","height":"34px"}'
								size="small"
