<template>
	<div class="addEdit-block">
		...
		>
			<template >
				<el-form-item class="input" v-if="type!='info'"  label="主题" prop="zhuti" >
					<el-input v-model="ruleForm.zhuti" placeholder="主题" clearable  :readonly="ro.zhuti"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="主题" prop="zhuti" >
			...
			<el-form-item v-else-if="ruleForm.neirong" label="内容" prop="neirong" >
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.neirong = this.ruleForm.neirong.replace(reg,'../../../springboot038x57l8/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
