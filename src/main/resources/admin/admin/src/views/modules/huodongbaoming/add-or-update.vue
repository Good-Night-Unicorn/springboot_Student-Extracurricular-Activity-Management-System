	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="报名人数" prop="huodongrenshu" >
					<el-input v-model.number="ruleForm.huodongrenshu" placeholder="报名人数" clearable  :readonly="ro.huodongrenshu"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="报名人数" prop="huodongrenshu" >
					<el-input v-model="ruleForm.huodongrenshu" placeholder="报名人数" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="input" v-if="type!='info'"  label="活动分类" prop="huodongfenlei" >
