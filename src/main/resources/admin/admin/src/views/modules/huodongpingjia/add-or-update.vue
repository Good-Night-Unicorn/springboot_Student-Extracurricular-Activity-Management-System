	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="select" v-if="type!='info'"  label="星级评价" prop="xingjipingjia" >
					<el-select :disabled="ro.xingjipingjia" v-model="ruleForm.xingjipingjia" placeholder="请选择星级评价" >
						<el-option
							v-for="(item,index) in xingjipingjiaOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item v-else class="input" label="星级评价" prop="xingjipingjia" >
					<el-input v-model="ruleForm.xingjipingjia"
						placeholder="星级评价" readonly></el-input>
				</el-form-item>
			...
			<el-form-item class="textarea" v-if="type!='info'" label="评价活动" prop="pingjiahuodong" >
				<el-input
					style="min-width: 200px; max-width: 600px;"
					type="textarea"
					:rows="8"
					placeholder="评价活动"
					v-model="ruleForm.pingjiahuodong" >
				</el-input>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.pingjiahuodong" label="评价活动" prop="pingjiahuodong" >
				<span class="text">{{ruleForm.pingjiahuodong}}</span>
			</el-form-item>
		...
		data() {
			return {
				...
				rules: {
					...
					pingjiahuodong: [
						{ required: true, message: '评价活动不能为空', trigger: 'blur' },
					],
					xingjipingjia: [
						{ required: true, message: '星级评价不能为空', trigger: 'blur' },
					],
					jiaoshigonghao: [
					],
					jiaoshixingming: [
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='pingjiahuodong'){
							this.ruleForm.pingjiahuodong = obj[o];
							this.ro.pingjiahuodong = true;
							continue;
						}
						if(o=='xingjipingjia'){
							this.ruleForm.xingjipingjia = obj[o];
							this.ro.xingjipingjia = true;
							continue;
						}
						if(o=='jiaoshigonghao'){
				...
				this.xingjipingjiaOptions = "⭐,⭐⭐,⭐⭐⭐,⭐⭐⭐⭐,⭐⭐⭐⭐⭐".split(',')
