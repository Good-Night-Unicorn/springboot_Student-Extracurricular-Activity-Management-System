<template>
	<div class="content" :style='{"padding":"0 0 20px 0","overflow":"hidden","background":"url(http://codegen.caihongy.cn/20250116/310285f13be5414cb3dcbdd3cb6bea17.png) center / 100% 100%,#111111","flexDirection":"column","display":"flex","width":"100%","position":"relative","height":"100%"}'>
		<div :style='{"padding":"24px 0 0","margin":"0","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"center","height":"100px","zIndex":"2"}'>
			<!-- 标题 -->
			<div :style='{"margin":"0","color":"transparent","textAlign":"center","background":"linear-gradient(rgb(253, 254, 255), rgba(30, 144, 255, 1)) text","width":"100%","fontSize":"26px","fontWeight":"800"}'>欢迎使用 {{this.$project.projectName}}</div>
			<!-- 时间 -->
			<div :style='{"top":"40px","color":"#e6effd","display":"inline-block","lineHeight":"44px","fontSize":"16px","position":"absolute","right":"10%","height":"44px"}'>{{ dates }} <span @click="backClick" style="cursor:pointer;padding: 0 0 0 8px;">管理界面</span></div>
		</div>
		<div :style='{"padding":"0 20px","flex":"auto","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"0","zIndex":"2"}'>
			<div :style='{"width":"25%","padding":"0","flexDirection":"column","display":"flex","gap":"10px","maxWidth":"392px"}'>
				<div class="echarts1">
					<div :style='{"padding":"18px 0 0 60px","margin":"0 0 10px 0","textAlign":"center","background":"url(http://codegen.caihongy.cn/20250116/5d2ae2fbc3634827ac90b80fed8bbda4.png) no-repeat left center / auto 100%","flex":"none","width":"100%","height":"48px"}'>
						<div :style='{"padding":"0","color":"#fff","textAlign":"left","background":"none","letterSpacing":"2px","fontSize":"18px","fontWeight":"600"}'>
							活动名称
						</div>
					</div>
					<div :style='{"width":"100%","padding":"10px 0 0","flex":"auto","background":"url(http://codegen.caihongy.cn/20250116/860b0066952645a9828cd6b6478ebb86.png) center / 100% 100%","height":"0"}'>
						<div id="huodongxinxiChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"padding":"18px 0 0 60px","margin":"0 0 10px 0","textAlign":"center","background":"url(http://codegen.caihongy.cn/20250116/5d2ae2fbc3634827ac90b80fed8bbda4.png) no-repeat left center / auto 100%","flex":"none","width":"100%","height":"48px"}'>
						<div :style='{"letterSpacing":"2px","fontSize":"18px","color":"#fff","textAlign":"left","background":"none","fontWeight":"600"}'>
							报名统计
						</div>
					</div>
					<div :style='{"width":"100%","padding":"10px 0 0","flex":"auto","background":"url(http://codegen.caihongy.cn/20250116/860b0066952645a9828cd6b6478ebb86.png) center / 100% 100%","height":"0"}'>
						<div id="huodongbaomingChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
			<div :style='{"width":"0","padding":"0","margin":"0 20px","flexDirection":"column","flex":"auto","display":"flex"}'>
				<!-- 统计 -->
				<div :style='{"padding":"10px","margin":"0","color":"#fff","alignItems":"center","display":"flex","justifyContent":"space-evenly","alignContent":"center","borderRadius":"10px","background":"#021933","gap":"12px","width":"100%","fontSize":"14px","height":"72px"}'>

					<div :style='{"padding":"0","margin":"0","alignItems":"center","background":"none","flexDirection":"row","flex":"1 1 auto","display":"flex","width":"190px","position":"relative","height":"auto","maxWidth":"240px"}'>
						<div :style='{"width":"37px","margin":"0","background":"url(http://codegen.caihongy.cn/20250116/a238d774d7c74abfaabe2db2f2b05e65.png) no-repeat center / 100% 100%","flex":"none","display":"block","height":"36px"}'></div>
						<div :style='{"padding":"0 0 0 6px","alignItems":"center","flexDirection":"column","flex":"auto","display":"flex","width":"100%","justifyContent":"center","height":"auto"}'>
							<div :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"inherit","textAlign":"left","width":"100%","fontSize":"12px","position":"relative","textOverflow":"ellipsis"}'>活动信息总数</div>
							<div :style='{"width":"100%","fontSize":"24px","color":"#ff950c","fontWeight":"bold"}'>{{huodongxinxiCount}}</div>
						</div>
					</div>

					<div :style='{"padding":"0","margin":"0","alignItems":"center","background":"none","flexDirection":"row","flex":"1 1 auto","display":"flex","width":"190px","position":"relative","height":"auto","maxWidth":"240px"}'>
						<div :style='{"width":"37px","margin":"0","background":"url(http://codegen.caihongy.cn/20250116/edf5f6eb574d4033bf6cbcc3feb5ddf1.png) no-repeat center / 100% 100%","flex":"none","display":"block","height":"36px"}'></div>
						<div :style='{"padding":"0 0 0 6px","alignItems":"center","flexDirection":"column","flex":"auto","display":"flex","width":"100%","justifyContent":"center","height":"auto"}'>
							<div :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"inherit","textAlign":"left","width":"100%","fontSize":"12px","position":"relative","textOverflow":"ellipsis"}'>活动报名总数</div>
							<div :style='{"width":"100%","fontSize":"24px","color":"#21fff2","fontWeight":"bold"}'>{{huodongbaomingCount}}</div>
						</div>
					</div>

					<div :style='{"padding":"0","margin":"0","alignItems":"center","background":"none","flexDirection":"row","flex":"1 1 auto","display":"flex","width":"190px","position":"relative","height":"auto","maxWidth":"240px"}'>
						<div :style='{"width":"37px","margin":"0","background":"url(http://codegen.caihongy.cn/20250116/5218379208ca46a99dc79d0f4b960ee1.png) no-repeat center / 100% 100%","flex":"none","display":"block","height":"36px"}'></div>
						<div :style='{"padding":"0 0 0 6px","alignItems":"center","flexDirection":"column","flex":"auto","display":"flex","width":"100%","justifyContent":"center","height":"auto"}'>
							<div :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"inherit","textAlign":"left","width":"100%","fontSize":"12px","position":"relative","textOverflow":"ellipsis"}'>活动评价总数</div>
							<div :style='{"width":"100%","fontSize":"24px","color":"#0c90ff","fontWeight":"bold"}'>{{huodongpingjiaCount}}</div>
						</div>
					</div>
				</div>
				<div class="echarts5">
					<div :style='{"padding":"0 0 0 48px","margin":"0","textAlign":"center","background":"url(http://codegen.caihongy.cn/20250114/a14196a680254a47be040b988fdfa027.png) no-repeat left center","flex":"none","width":"100%","height":"50px"}'>
						<div :style='{"color":"#fff","textAlign":"left","background":"none","letterSpacing":"2px","fontSize":"18px","lineHeight":"50px","fontWeight":"600"}'>
							活动信息
						</div>
					</div>
					<el-table id="huodongxinxiTable" :data="huodongxinxiList" border :stripe="true" :style='{"padding":"0","borderColor":"rgba(92,135,230,.3)","borderWidth":"0","background":"none","width":"100%","overflow-y":"scroll","borderStyle":"solid","height":"calc(100% - 36px)"}'>
						<el-table-column :resizable="true" :sortable="false" prop="huodongmingcheng" label="活动名称">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="huodongfenlei" label="活动分类">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="shijian" label="时间">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="fengmian" label="封面">
							<template slot-scope="scope">
								<div v-if="scope.row.fengmian">
									<img v-if="scope.row.fengmian.substring(0,4)=='http'&&scope.row.fengmian.split(',w').length>1" :src="scope.row.fengmian" width="30" height="30">
									<img v-else-if="scope.row.fengmian.substring(0,4)=='http'" :src="scope.row.fengmian.split(',')[0]" width="30" height="30">
			...
			<div :style='{"padding":"0","flexWrap":"wrap","flexDirection":"column","display":"flex","gap":"10px","width":"25%","justifyContent":"space-between","maxWidth":"392px"}'>
				<div class="echarts3">
					<div :style='{"padding":"18px 0 0 60px","margin":"0 0 10px 0","textAlign":"center","background":"url(http://codegen.caihongy.cn/20250116/4fa83b6e74224470a7d1488f1c37f4a5.png) no-repeat left center / auto 100%","flex":"none","width":"100%","height":"48px"}'>
						<div :style='{"letterSpacing":"2px","fontSize":"18px","color":"#fff","textAlign":"left","background":"none","fontWeight":"600"}'>
							报名分类
						</div>
					</div>
					<div :style='{"width":"100%","padding":"10px 0 0","flex":"auto","background":"url(http://codegen.caihongy.cn/20250116/860b0066952645a9828cd6b6478ebb86.png) center / 100% 100%","height":"0"}'>
						<div id="huodongbaomingChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts4">
					<div :style='{"padding":"18px 0 0 60px","margin":"0 0 10px 0","textAlign":"center","background":"url(http://codegen.caihongy.cn/20250116/4fa83b6e74224470a7d1488f1c37f4a5.png) no-repeat left center / auto 100%","flex":"none","width":"100%","height":"48px"}'>
					...
					<div :style='{"width":"100%","padding":"10px 0 0","flex":"auto","background":"url(http://codegen.caihongy.cn/20250116/860b0066952645a9828cd6b6478ebb86.png) center / 100% 100%","height":"0"}'>
						<div id="huodongpingjiaChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
		...
		methods:{
			gethuodongxinxiList() {
				...
				this.$http({
					...
					if (data && data.code === 0) {
						this.huodongxinxiList = data.data.list;
						let div = document.getElementById('huodongxinxiTable')
						var scrollTop = -1
						function move() {
							if (div){
						...
						this.huodongxinxiTimer = setInterval(move, 2000);
						div.addEventListener('mouseenter', e => {
							e.stopPropagation()
							clearInterval(this.huodongxinxiTimer);
						})
			...
			gethuodongxinxiCount() {
				this.$http({
					...
					if (data && data.code == 0) {
						this.huodongxinxiCount = data.data
					}
				})
			},
			//统计接口1
			huodongxinxiChat1() {
				this.$nextTick(()=>{
					...
					this.$http({
						url: "group/huodongxinxi/huodongmingcheng",
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
							...
							var option = {};
							this.wordclouds(pArray,'huodongxinxiChart1');
			...
			huodongbaomingChat2() {
				this.$nextTick(()=>{
					...
					var huodongbaomingChart2 = echarts.init(document.getElementById("huodongbaomingChart2"),'macarons');
					this.$http({
						url: `huodongbaoming/value/huodongmingcheng/huodongrenshu`,
						method: "get",
						params: {
							order: 'desc'
						}
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							huodongbaomingChart2.setOption(option);
				
							this.myChartInterval(1, option.xAxis.data, option.series[0].data, huodongbaomingChart2)

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								huodongbaomingChart2.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			huodongbaomingChat3() {
				this.$nextTick(()=>{
					...
					var huodongbaomingChart3 = echarts.init(document.getElementById("huodongbaomingChart3"),'macarons');
					this.$http({
						url: "huodongbaoming/group/huodongfenlei",
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
							...
							// 使用刚指定的配置项和数据显示图表。
							huodongbaomingChart3.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								huodongbaomingChart3.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			gethuodongpingjiaCount() {
				this.$http({
					url: `huodongpingjia/count`,
					method: "get"
				}).then(({
					data
				}) => {
					if (data && data.code == 0) {
						this.huodongpingjiaCount = data.data
					}
				})
			},
			//统计接口1
			huodongpingjiaChat4() {
				this.$nextTick(()=>{
					...
					var huodongpingjiaChart4 = echarts.init(document.getElementById("huodongpingjiaChart4"),'macarons');
					this.$http({
						url: "huodongpingjia/group/xingjipingjia",
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
							...
							for(let i=0;i<res.length;i++){
								...
								xAxis.push(res[i].xingjipingjia);
								yAxis.push(parseFloat((res[i].total)));
								pArray.push({
									value: parseFloat((res[i].total)),
									name: res[i].xingjipingjia
								})
							}
							var option = {};
							let titleObj = this.pie.title
							...
							// 使用刚指定的配置项和数据显示图表。
							huodongpingjiaChart4.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								huodongpingjiaChart4.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
