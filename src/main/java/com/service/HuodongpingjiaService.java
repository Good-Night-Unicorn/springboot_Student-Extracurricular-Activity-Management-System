...
public interface HuodongpingjiaService extends IService<HuodongpingjiaEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<HuodongpingjiaEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<HuodongpingjiaEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<HuodongpingjiaEntity> wrapper);
