...
public class HuodongpingjiaModel  implements Serializable {
	...
	public void setPingjiahuodong(String pingjiahuodong) {
		this.pingjiahuodong = pingjiahuodong;
	}
	
	/**
	 * 获取：评价活动
	 */
	public String getPingjiahuodong() {
		return pingjiahuodong;
	}
