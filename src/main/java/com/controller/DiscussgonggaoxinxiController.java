...
public class DiscussgonggaoxinxiController {
    ...
    public R info(@PathVariable("id") Long id){
        ...
        Map<String, String> deSens = new HashMap<>();
        //给需要脱敏的字段脱敏
        DeSensUtil.desensitize(discussgonggaoxinxi,deSens);
    ...
    public R save(@RequestBody DiscussgonggaoxinxiEntity discussgonggaoxinxi, HttpServletRequest request){
        ...
        return R.ok().put("data",discussgonggaoxinxi.getId());
    }
    ...
    public R security(@RequestParam String username){
        DiscussgonggaoxinxiEntity discussgonggaoxinxi = discussgonggaoxinxiService.selectOne(new EntityWrapper<DiscussgonggaoxinxiEntity>().eq("", username));
        return R.ok().put("data", discussgonggaoxinxi);
    }
    ...
    public R update(@RequestBody DiscussgonggaoxinxiEntity discussgonggaoxinxi, HttpServletRequest request){
        //ValidatorUtils.validateEntity(discussgonggaoxinxi);
        //全部更新
        discussgonggaoxinxiService.updateById(discussgonggaoxinxi);
        return R.ok();
    }
    ...
    public R autoSort(@RequestParam Map<String, Object> params,DiscussgonggaoxinxiEntity discussgonggaoxinxi, HttpServletRequest request,String pre){
        EntityWrapper<DiscussgonggaoxinxiEntity> ew = new EntityWrapper<DiscussgonggaoxinxiEntity>();
